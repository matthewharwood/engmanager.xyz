...
export function renderReport(root, model) {
  const article = element('article', {className: 'personality-report personality-report-v2', 'data-report-layout': 'v2'});
  const nav = element('nav', {className: 'report-workflow-nav', 'aria-label': 'Report sections'});
  for (const [href, text] of [['#report-kit', 'Report kit'], ['#your-scores', 'Your scores'], ['#score-details', 'Details']]) nav.append(element('a', {href, text, 'data-report-anchor': ''}));
  article.append(nav);
