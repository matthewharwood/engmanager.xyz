...
function report(){
  ...
  const files=el('details',null,{class:'report-optional-files'});files.append(el('summary','Backups and other exports'),p('The report kit is a writing prompt with your evidence and approved story details. JSON backups restore the scored assessment in this app. The scores PDF contains your numeric report and any kept local reflection. Your chosen LLM creates the illustrated atlas PDF from the kit.'));
