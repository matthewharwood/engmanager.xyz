...
function report(){
  const header=heading('04 / YOUR REPORT','How to work with this person.','A company-facing account of your working style, what others could misread, and the support worth discussing together.');
