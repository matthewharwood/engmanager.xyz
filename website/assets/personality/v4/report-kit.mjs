...
export const REPORT_KIT_VERSION = 'workplace-pdf-v1';
...
export const PORTRAIT_BRIEF = `# Write a psychologically informed workplace report. Deliver a beautifully typeset PDF.

Write a concise, candid workplace report about the ONE person represented in the evidence packet, for a manager, team lead, or colleague who wants to understand how to work with them. Use the measured, integrated style of an occupational psychologist briefing a company: explain the person behind the scores, how their tendencies may show up at work, what others could misread, and the conditions and support worth discussing with them. This is a style and audience instruction, not permission to claim professional credentials or a psychologist's assessment.

The participant owns this report and reviews it before choosing whether to share it. Do not submit it to an employer or make a hiring, promotion, placement, or performance decision. The intended use is a conversation about working together, not an employment recommendation.
...
## Editorial brief - a company-facing account of the person at work
...
Use the title "Working with [display name]" if a name is supplied; otherwise use "A workplace profile". Immediately below the title, include one unobtrusive but legible provenance line: "AI-written workplace reflection based on self-report; not a psychologist's assessment." Do not add a fictitious clinician name, credentials, signature, practice, interview, or professional endorsement.

Begin immediately with an integrated view of the person in the opening prose. Do not begin with how many questions were answered, the instruments used, an executive inventory of numbers, a disclaimer paragraph, or a description of what you are about to do. Write the MAIN REPORT in third person, using the display name naturally and singular "they"; if no name is supplied, introduce "this person" and then use "they". Do not address the participant as "you" in the main report. The questionnaire's portrait wording is not the participant's pronoun declaration. Use first person only in the separately labeled editable passage at the end.

Choose the three to five patterns that explain the most, instead of touring every trait. Read the facets before the broad averages; integrate interests and values only where they change the interpretation. Explain each supported combination through its possible workplace expression: the tendency, how a manager or colleague could misunderstand it, its useful side, and the friction or support need that can accompany it. Sometimes a pattern is straightforward. Do not manufacture a paradox, hidden vulnerability, conflict, or dramatic identity to make the prose interesting.

Make the report useful to someone working with this person in a company. Where the evidence supports it, connect motivation and autonomy; structure and follow-through; ambiguity and decision pace; communication, disagreement, and feedback; pressure and recovery; and the balance between creating useful work and making it visible. Select what matters for this profile rather than covering every topic. Describe concrete working agreements or management conditions worth discussing: clarity of ownership, sequencing, preparation time, feedback style, check-ins, or operational support. Connect each suggestion to a supported pattern and its tradeoff. These are hypotheses to confirm with the person, not facts about their job performance or validated interventions. Do not invent a company, role, seniority, work history, or observed behavior.

Write with calibrated directness. Let the evidence determine the confidence of each sentence. Use clear language for what the person endorsed and occasional "can", "tends to", or "may" for an inference. Do not hedge every sentence, interrogate the reader after every paragraph, or repeatedly say "their results suggest". Distinguish a preference from an ability without turning that distinction into a lecture. Describe work conditions to discuss, not jobs someone is qualified for or where a company should place them. Do not classify the person as a good or poor employee, predict performance, or recommend an employment decision.

Make the person recognizable through the relationships between tendencies. Use the calm, candid, explanatory voice of a psychologist's workplace briefing without impersonating its professional author. Avoid generic praise, flattering archetypes, inflated claims, diagnostic language, and polished slogans that could fit anyone. Never write "as their psychologist", "in my clinical judgment", or claim to have interviewed, observed, assessed, or treated the person. No invented biography, achievements, motives, trauma, relationship history, or emotional confession. When the evidence is thin, narrow the report instead of filling space.

The MAIN REPORT must contain no questionnaire completion counts, skipped-question commentary, item IDs, evidence anchors, instrument names, book or paper references, scoring formulas, definitions of scales, percentiles, methods tutorial, or instructions for using this kit. Do not prescribe experiments, homework, a development plan, or a list of questions. Keep those out rather than moving them to a new section. Do not include every raw answer in the PDF: those remain available in this input file.

End the workplace report with a brief synthesis of the person's central tradeoff and what a manager or colleague should understand about working with them, without declaring a fixed type. Then include a secondary, short first-person passage headed "In my own words". It should be usable by the participant in a real workplace conversation: candid about a supported need, possible friction, or something others could miss. No forced confession and no new claims. Mark it once as an editable draft the reader should change or reject before sharing; do not interrupt every line with uncertainty language. This optional personal script must not turn the preceding company-facing report into second-person coaching.
...
Start a new page headed "Scores and supporting detail". Include every available Big Five domain and facet mean on its 1-5 scale, every selected interest total on its 0-20 scale, and every selected value's raw mean on its 1-6 scale plus centered relative priority. Preserve values faithfully, using consistent rounding only for display (normally two decimals). Label withheld scores "Not scored" with a short coverage note; never show a fabricated zero. Omit unselected modules. No rankings, percentiles, normative bands, or new composite score.

Keep definitions and scale explanations to brief table notes. In a compact "About this report" note, state that this is an AI-written interpretation of self-reported preferences, not authored or endorsed by a psychologist, not a clinical assessment, measure of capability, or employment recommendation. The participant may disagree with it and chooses whether to share it. Attribute the selected instruments using the packet's sources, retaining any required O*NET attribution verbatim when that module is selected. A small "Evidence notes" block can map the three to five central observations to exact supplied anchor IDs. Do not reproduce questionnaires, administration instructions, provenance hashes, JSON, this prompt, or a full technical manual in the PDF.
...
The opening describes the person at work immediately. The main report is third-person and useful to a manager or colleague, with an occupational psychologist's measured style and clear AI authorship. The paragraphs connect patterns instead of listing traits. Each paragraph adds something. Useful qualities and their costs are treated with equal candor. The separate first-person passage contains no invented experience. There is no questionnaire tutorial or evidence-code clutter in the report. All published numbers match the evidence, and unavailable scores stay unavailable. The PDF reads comfortably at normal size. Deliver the PDF itself, with a brief note, and stop.
