import {RELEASE} from '/assets/personality/v4/release.mjs';
import {AI_CACHE} from '/assets/personality/v1/ai-cache-config.mjs';
import {releaseSource} from '/assets/personality/v4/release-format.mjs';

const ASSET_ROOT = '/assets/personality/v4/';
...
const READY_PATH = '/personality/.offline-ready-v4';
...
const cacheNamePromise = digestPromise.then(digest => `personality-v4-${digest}`);
