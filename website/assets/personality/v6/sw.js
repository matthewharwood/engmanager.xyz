import {RELEASE} from '/assets/personality/v6/release.mjs';
import {AI_CACHE} from '/assets/personality/v1/ai-cache-config.mjs';
import {releaseSource} from '/assets/personality/v6/release-format.mjs';

const ASSET_ROOT = '/assets/personality/v6/';
...
const READY_PATH = '/personality/.offline-ready-v6';
...
const cacheNamePromise = digestPromise.then(digest => `personality-v6-${digest}`);
