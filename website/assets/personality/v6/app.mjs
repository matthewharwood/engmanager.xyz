...
function prepare() {
  ...
  for(const [label,href] of [['Birthday and tarot','#story-symbols-editor'],['35 background questions','#story-background'],['48 preference questions','#story-type-editor'],['170 scored questions','#scored-profiles']]){
