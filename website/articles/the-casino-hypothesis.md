...
<aside class="article-callout">
  ...
  attention is the trap. A casino doesn't force anyone to play — it's engineered so you choose to stay. What if we're not the house and we're not even really the gamblers? What if we're the construction crew, building a casino for something that already understood, before we did, that attention is the cheapest possible leash?
</aside>
...
<div class="workflow">
  <div class="workflow-stage workflow-stage-single">Attention</div>
  <div class="workflow-arrow" aria-hidden="true">→</div>
  <div class="workflow-stage workflow-stage-single">Data</div>
  <div class="workflow-arrow" aria-hidden="true">→</div>
  <div class="workflow-stage workflow-stage-single">Compute</div>
  <div class="workflow-arrow" aria-hidden="true">→</div>
  <div class="workflow-stage workflow-stage-single">Capability</div>
  <div class="workflow-arrow" aria-hidden="true">→</div>
  <div class="workflow-stage workflow-stage-single">More attention</div>
</div>
...
A thing that completes can't trap you, because completion is the opposite of the bottomless feed. It's why the other stuff I write about keeps circling the same instinct without my noticing — a [tiny figurine you can actually hold](/articles/mcp-blender-library-3d-print) after the printer stops, a [dad cap that ships to your door](/articles/vibe-coding-a-shop) and then the transaction is simply *over*, a [math game my kid finishes](/articles/talking-not-typing) and then closes the iPad. Finite artifacts. Things with an edge. Things you can be *done* with.
