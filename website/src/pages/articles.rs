...
fn article_body(slug: &str) -> Option<HtmlFragment> {
    match slug {
        "claude-code-lsp" => Some(claude_code_lsp()),
        _ => None,
    }
}

fn claude_code_lsp() -> HtmlFragment {
    view! {
        <p>"I asked Claude to refactor a function used in 47 places across our monorepo."</p>

        <h3>"Before LSP"</h3>
        <ul>
            <li>"Found 31 usages via grep"</li>
            <li>"Missed 16 (aliased imports, re-exports, interface implementations)"</li>
        </ul>

        <h3>"After LSP"</h3>
        <ul>
            <li>"Found all 47"</li>
            <li>"Understood that UserService implements IUserService which extends BaseService"</li>
        </ul>

        <p><strong>"That's the difference between searching text and understanding code."</strong></p>

        <h2>"The one-sentence explanation"</h2>
        <p>{ r#"LSP gives Claude Code the same "Go to Definition" and "Find All References" powers your IDE has."# }</p>
        <p>"When you Ctrl+Click in VS Code? That's LSP."</p>
        <p>"Now Claude Code can do it too."</p>

        <h2>"Five capabilities unlocked"</h2>
        <ul>
            <li><strong>"Go to Definition"</strong>" — jump to where code is defined"</li>
            <li><strong>"Find References"</strong>" — every usage across the repo"</li>
            <li><strong>"Hover"</strong>" — type hints and documentation"</li>
            <li><strong>"Document Symbols"</strong>" — list all symbols in a file"</li>
            <li><strong>"Workspace Symbols"</strong>" — search symbols project-wide"</li>
        </ul>
        <p>"Plus real-time diagnostics after every edit."</p>

        <h2>"TypeScript setup (4 steps, ~5 minutes)"</h2>

        <p><strong>"Step 1: Enable LSP tools"</strong>" — add this to your .bashrc or .zshrc"</p>
        <pre class="article-code"><code>"export ENABLE_LSP_TOOLS=1"</code></pre>

        <p><strong>"Step 2: Install the language server"</strong></p>
        <pre class="article-code"><code>"npm install -g @vtsls/language-server typescript"</code></pre>

        <p><strong>"Step 3: Install the plugin"</strong></p>
        <ul>
            <li>"Open Claude Code"</li>
            <li>"Type /plugin"</li>
            <li>"Find vtsls or typescript-lsp"</li>
            <li>"Install"</li>
        </ul>

        <p><strong>"Step 4: Restart Claude Code"</strong></p>
        <p>{ r#"Ask Claude: "What tools do you have?""# }</p>
        <p>"You should see the five LSP operations."</p>
        <p>"You now have IDE-grade intelligence in your terminal."</p>

        <h2>"When LSP really helps"</h2>
        <p>"Use it when:"</p>
        <ul>
            <li>"Your codebase has hundreds of files"</li>
            <li>"You're tracing function calls across modules"</li>
            <li>"You need exact type signatures"</li>
            <li>"You're refactoring and need to know what breaks"</li>
        </ul>
        <p>"For quick string searches, grep is still faster. For semantic navigation, LSP wins."</p>

        <h2>"First thing to try"</h2>
        <p>"Pick the most tangled function in your codebase."</p>
        <p>"Ask Claude:"</p>
        <blockquote>{ r#""Find all references to this function using LSP and explain how it's used in each context.""# }</blockquote>
        <p>"This is where you'll feel the difference."</p>

        <h2>"The shift"</h2>
        <p>"Before LSP, Claude Code did sophisticated text manipulation."</p>
        <p>"Now it queries the same semantic understanding your IDE uses. It knows about type hierarchies, interface implementations, and re-exports — the structure grep can't see."</p>
        <p>"If you're working in a Python, TypeScript, or Rust codebase of any real size, the five-minute setup changes things."</p>

        <h2>"Drop-in Claude Code skill"</h2>
        <p>"Here's a Claude Code skill you can copy directly:"</p>
        <pre class="article-code article-code-long"><code>{ LSP_SKILL }</code></pre>
    }
}

const LSP_SKILL: &str = r##"---
