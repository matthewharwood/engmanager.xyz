...
mod tests {
    ...
    async fn personality_worker_bypasses_browser_and_edge_caches() {
        ...
        let pinned = get(&router, SITE_HOST, "/assets/personality/v2/sw.js").await;
        assert_eq!(
        ...
        assert!(
            body_string(legacy)
                .await
                .contains("/assets/personality/v1/release.mjs")
        );
    }
    ...
    async fn personality_assets_resolve_only_exact_release_paths() {
        ...
        assert_eq!(
            asset_url("personality/v2/bootstrap.mjs"),
        ...
        for path in [
            ...
            "/assets/personality/v2/bootstrap.12345678.mjs",
        ] {
            assert_eq!(
